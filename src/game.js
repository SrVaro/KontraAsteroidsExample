...
function createAsteroid(x, y, radius) {
  let asteroid = kontra.Sprite({
    ...
    radius: radius,
    render() {
      this.context.strokeStyle = 'white';      this.context.beginPath();  // start drawing a shape
...
let ship = kontra.Sprite({ 
  ...
  render() {
    ...
    this.context.rotate(degreesToRadians(this.rotation));    // draw a right facing triangle
